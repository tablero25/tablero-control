  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route path="/sistema-tablero/atencion-medica" element={
          user ? (
            <div>
              <Header user={user} handleLogout={handleLogout} />
              <AtencionMedica />
        ...
        <Route path="/sistema-tablero/ranking-diagnostico" element={
          user ? (
            <div>
              <Header user={user} handleLogout={handleLogout} />
              <RankingDiagnostico />
              ...
              <div className="tablero-bg">
                ...
                <div className="container">
                  <Routes>
                    ...
                    <Route path="/sistema-tablero/indicadores-camas" element={<IndicadoresCamas />} />
                    <Route path="/sistema-tablero/indicadores-camas/:nombre" element={<IndicadoresCamasEstablecimiento />} />
                    <Route path="/sistema-tablero/atencion-medica" element={<AtencionMedica />} />
                    <Route path="/sistema-tablero/atencion-medica/:nombre" element={<AtencionMedicaEstablecimiento />} />
                    <Route path="/sistema-tablero/ranking-diagnostico" element={<RankingDiagnostico />} />
                    <Route path="/sistema-tablero/ranking-diagnostico/:nombre" element={<RankingDiagnosticoEstablecimiento />} />
                    <Route path="/sistema-tablero/ranking-diagnostico/:nombre/:categoria" element={<RankingDiagnosticoCategoria />} />
                  </Routes>
                </div>
              </div>
            </div>
        ...
        <Route path="/sistema-tablero/indicadores-camas/:nombre" element={
          user ? (
        ...
        <Route path="/sistema-tablero/atencion-medica/:nombre" element={
          user ? (
        ...
        <Route path="/sistema-tablero/ranking-diagnostico/:nombre" element={
          user ? (
        ...
        <Route path="/sistema-tablero/ranking-diagnostico/:nombre/:categoria" element={
          user ? (
