// Archivo de ejemplo para configuración de email
// Copia este archivo como emailConfig.js y configura tus credenciales
...
const createTransporter = async () => {
  ...
  return nodemailer.createTransporter({
    service: 'gmail',
    auth: {
      user: 'tu-email@gmail.com', // CAMBIA: Tu email de Gmail
      pass: 'tu-contraseña-de-aplicacion' // CAMBIA: Tu contraseña de aplicación
    }
  });
